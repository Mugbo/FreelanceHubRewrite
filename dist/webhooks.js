...
var StripeWebhook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var webhookRequest, body, signature, event, session, payload, orders, order, workSearch;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                orders = (_b.sent()).docs;
                if (!orders) {
                    return [2 /*return*/, res.status(400).send("Webhook Error: No order in payload")];
                }
                order = orders[0];
            ...
            case 3:
                _b.sent();
                workSearch = order.work;
                if (!workSearch.id) {
                    return [2 /*return*/, res.status(400).send("Webhook Error: work id on order")];
                }
                return [4 /*yield*/, payload.update({
                        collection: "work",
                        data: {
