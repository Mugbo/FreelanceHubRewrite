...
var VerifyEmail = function (_a) {
    ...
    if (isError) {
        return (React.createElement("div", { className: "flex flex-col items-center gap -2" },
            ...
            React.createElement("h3", { className: "font-semibold text-xl" }, "There has been a Problem"),
            React.createElement("p", { className: "text-muted-foreground text-sm" }, "invalid token. try again")));
    }
    if (data === null || data === void 0 ? void 0 : data.success) {
        return (React.createElement("div", { className: "flex h-full flex-col items-center justify-center" },
            React.createElement("div", { className: "relative mb-4 h-60 w-60 text-muted-foreground" },
                React.createElement(image_1.default, { src: "/screenshot.io", fill: true, alt: "email sent" })),
            React.createElement("h3", { className: "font-semibold text-2xl" }, "You are all ready to go "),
