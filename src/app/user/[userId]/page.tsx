...
<div className=" mt-10 z-10 bg-white shadow-md border border-gray-100 rounded-3xl">
  <div className="px-4 py-5 mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div className="flex items-start space-x-6"> {/* Adjusted for horizontal layout */}
      {/* Image on the left */}
      <Image src={imageUrl} alt="User Profile" width={300} height={300} className="flex-shrink-0 rounded-lg" />

      {/* Text content on the right */}
      <div className="flex flex-col space-y-4"> {/* Adjusted for vertical layout of text */}
